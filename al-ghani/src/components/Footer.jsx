      ...
      <div className="ftr-i">
        <div className="ftr-top">
          ...
          <div className="ftr-col">
            ...
            <ul>
              <li><a href="#">
                <span><i className="fas fa-map-marker-alt"></i></span> {isUr ? "لاہور، پاکستان" : "Lahore, Pakistan"}
              </a></li>
              <li><a href="tel:+923270930991">
                <span><i className="fas fa-phone"></i></span> +92-327-0930991
              </a></li>
              <li><a href="mailto:hakeemwaheedahmadghani@gmail.com">
                <span><i className="fas fa-envelope"></i></span> {isUr ? "ای میل کریں" : "Email Us"}
              </a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="ftr-bot">
          <p className="ftr-copy">
            {isUr ? (
              <>
                © ۲۰۲۶ الغنی دواخانہ۔ تمام حقوق محفوظ ہیں۔ | لاہور، پاکستان میں بنایا گیا{" "}
                <i className="fas fa-heart" style={{ color: "#e63946" }}></i>
              </>
            ) : (
              <>
                © 2026 Al Ghani Dawa Khana. All rights reserved. | Made with{" "}
                <i className="fas fa-heart" style={{ color: "#e63946" }}></i> in Lahore, Pakistan
              </>
            )}
          </p>
